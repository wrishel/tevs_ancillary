...
from basicdiebold_ballot_side import BasicdieboldBallotSide

class BasicdieboldBallot(Ballot):
    ...
    def __init__(self, image_filenames, extensions):
        super(BasicdieboldBallot, self).__init__(image_filenames, extensions)
        def add_page(number, fname):
            nbs = BasicdieboldBallotSide(
                ballot=self,
                dpi=const.dpi,
...
if __name__ == "__main__":
    print "Test by setting the configuration file to brand Basicdiebold"
