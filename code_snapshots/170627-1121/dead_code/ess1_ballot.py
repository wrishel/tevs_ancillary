...
def oval_pattern(im,height,width,text_offset):
    ...
    try:
        ...
        return False
    # added to simplify Saguache template creation from existing ballots !!!
    center_ok = True
...
page offsets (%d,%d) scaled page offsets (%d,%d), template offsets (%d,%d)" % (
    ...
    def get_layout_code(self, page):
        ...
        # !!! changed front_adj_x from -0.86 to -0.83 on 9/10/11 8:12
...
def adjust_ulc(image,left_x,top_y,max_adjust=16):
