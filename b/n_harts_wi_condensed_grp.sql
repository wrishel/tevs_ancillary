-- View: n_harts_wi_condensed_grp

-- DROP VIEW n_harts_wi_condensed_grp;

CREATE OR REPLACE VIEW n_harts_wi_condensed_grpn_harts_wi_condensed_grp AS 
 SELECT max(n_harts_wi_condensed.precinct_name::text) AS precinct_name,
    ...
    NULL AS turn_out,  -- this is not really valid
    max(n_harts_wi_condensed.contest_id) AS contest_id,
    NULL AS contest_seq_nbr,
